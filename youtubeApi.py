...
"""This function returns a dictionnary with the title,
url and creation date of the channel
Test: check that the function correctly returns a
dictionnary with the title, url and creation date of the channel"""
...
print(get_channel_dic("UCtJ3xivtW_ZxG0sOBz8HtyA")['kind'])
